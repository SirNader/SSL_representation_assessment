...
class NnclrNoqueueHead(ContrastiveHeadBase):
    def __init__(self, temperature, proj_hidden_dim, pred_hidden_dim, **kwargs):
    ...
    def _get_loss(self, outputs, idx, y):
        ...
        loss0 = nnclr_loss_fn(predicted0, normed_projected1, temperature=self.temperature)
        loss1 = nnclr_loss_fn(predicted1, normed_projected0, temperature=self.temperature)
        loss = (loss0 + loss1) / 2
