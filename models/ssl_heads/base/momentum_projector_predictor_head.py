...
from .projector_predictor_head import ProjectorPredictorHead


class MomentumProjectorPredictorHead(ProjectorPredictorHead):
    def __init__(self, target_factor=None, target_factor_schedule=None, **kwargs):
        ...
        assert type(self)._model_specific_initialization == \
               MomentumProjectorPredictorHead._model_specific_initialization
